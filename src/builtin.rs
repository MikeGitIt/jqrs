...
pub fn builtins_bind<T>(_jq: &mut JqState<T>, bb: Block) -> Block {
    ...
    let function_list: Vec<Cfunction> = vec![
        // Core functions
        Cfunction { fptr: None, name: Some("keys"), nargs: 1 },
        Cfunction { fptr: None, name: Some("keys_unsorted"), nargs: 1 },
        Cfunction { fptr: None, name: Some("to_entries"), nargs: 1 },
        Cfunction { fptr: None, name: Some("length"), nargs: 1 },
        Cfunction { fptr: None, name: Some("utf8bytelength"), nargs: 1 },
        Cfunction { fptr: None, name: Some("type"), nargs: 1 },
        Cfunction { fptr: None, name: Some("has"), nargs: 2 },
        Cfunction { fptr: None, name: Some("contains"), nargs: 2 },
        Cfunction { fptr: None, name: Some("sort"), nargs: 1 },
        Cfunction { fptr: None, name: Some("_sort_by_impl"), nargs: 2 },
        Cfunction { fptr: None, name: Some("_group_by_impl"), nargs: 2 },
        Cfunction { fptr: None, name: Some("min"), nargs: 1 },
        Cfunction { fptr: None, name: Some("max"), nargs: 1 },
        Cfunction { fptr: None, name: Some("_min_by_impl"), nargs: 2 },
        Cfunction { fptr: None, name: Some("_max_by_impl"), nargs: 2 },

        // String functions
        Cfunction { fptr: None, name: Some("startswith"), nargs: 2 },
        Cfunction { fptr: None, name: Some("endswith"), nargs: 2 },
        Cfunction { fptr: None, name: Some("split"), nargs: 2 },
        Cfunction { fptr: None, name: Some("explode"), nargs: 1 },
        Cfunction { fptr: None, name: Some("implode"), nargs: 1 },
        Cfunction { fptr: None, name: Some("_strindices"), nargs: 2 },
        Cfunction { fptr: None, name: Some("trim"), nargs: 1 },
        Cfunction { fptr: None, name: Some("ltrim"), nargs: 1 },
        Cfunction { fptr: None, name: Some("rtrim"), nargs: 1 },

        // Path functions
        Cfunction { fptr: None, name: Some("getpath"), nargs: 2 },
        Cfunction { fptr: None, name: Some("setpath"), nargs: 3 },
        Cfunction { fptr: None, name: Some("delpaths"), nargs: 2 },

        // Conversion functions
        Cfunction { fptr: None, name: Some("tonumber"), nargs: 1 },
        Cfunction { fptr: None, name: Some("tostring"), nargs: 1 },
        Cfunction { fptr: None, name: Some("tojson"), nargs: 1 },
        Cfunction { fptr: None, name: Some("fromjson"), nargs: 1 },

        // Type checking functions
        Cfunction { fptr: None, name: Some("isinfinite"), nargs: 1 },
        Cfunction { fptr: None, name: Some("isnan"), nargs: 1 },
        Cfunction { fptr: None, name: Some("isnormal"), nargs: 1 },
        Cfunction { fptr: None, name: Some("infinite"), nargs: 1 },
        Cfunction { fptr: None, name: Some("nan"), nargs: 1 },

        // Math functions (from libm)
        Cfunction { fptr: None, name: Some("floor"), nargs: 1 },
        Cfunction { fptr: None, name: Some("ceil"), nargs: 1 },
        Cfunction { fptr: None, name: Some("round"), nargs: 1 },
        Cfunction { fptr: None, name: Some("sqrt"), nargs: 1 },
        Cfunction { fptr: None, name: Some("fabs"), nargs: 1 },
        Cfunction { fptr: None, name: Some("sin"), nargs: 1 },
        Cfunction { fptr: None, name: Some("cos"), nargs: 1 },
        Cfunction { fptr: None, name: Some("tan"), nargs: 1 },
        Cfunction { fptr: None, name: Some("asin"), nargs: 1 },
        Cfunction { fptr: None, name: Some("acos"), nargs: 1 },
        Cfunction { fptr: None, name: Some("atan"), nargs: 1 },
        Cfunction { fptr: None, name: Some("log"), nargs: 1 },
        Cfunction { fptr: None, name: Some("log10"), nargs: 1 },
        Cfunction { fptr: None, name: Some("log2"), nargs: 1 },
        Cfunction { fptr: None, name: Some("exp"), nargs: 1 },
        Cfunction { fptr: None, name: Some("exp10"), nargs: 1 },
        Cfunction { fptr: None, name: Some("exp2"), nargs: 1 },
        Cfunction { fptr: None, name: Some("expm1"), nargs: 1 },
        Cfunction { fptr: None, name: Some("pow"), nargs: 3 },
        Cfunction { fptr: None, name: Some("atan2"), nargs: 3 },
        Cfunction { fptr: None, name: Some("fma"), nargs: 4 },

        // Error and control
        Cfunction { fptr: None, name: Some("error"), nargs: 1 },
        Cfunction { fptr: None, name: Some("format"), nargs: 2 },
        Cfunction { fptr: None, name: Some("halt"), nargs: 1 },
        Cfunction { fptr: None, name: Some("halt_error"), nargs: 2 },

        // Environment and I/O
        Cfunction { fptr: None, name: Some("env"), nargs: 1 },
        Cfunction { fptr: None, name: Some("now"), nargs: 1 },
        Cfunction { fptr: None, name: Some("debug"), nargs: 1 },
        Cfunction { fptr: None, name: Some("stderr"), nargs: 1 },
        Cfunction { fptr: None, name: Some("input"), nargs: 1 },
        Cfunction { fptr: None, name: Some("input_filename"), nargs: 1 },
        Cfunction { fptr: None, name: Some("input_line_number"), nargs: 1 },
        Cfunction { fptr: None, name: Some("have_decnum"), nargs: 1 },
        Cfunction { fptr: None, name: Some("have_literal_numbers"), nargs: 1 },

        // Date/time functions
        Cfunction { fptr: None, name: Some("strptime"), nargs: 2 },
        Cfunction { fptr: None, name: Some("strftime"), nargs: 2 },
        Cfunction { fptr: None, name: Some("strflocaltime"), nargs: 2 },
        Cfunction { fptr: None, name: Some("mktime"), nargs: 1 },
        Cfunction { fptr: None, name: Some("gmtime"), nargs: 1 },
        Cfunction { fptr: None, name: Some("localtime"), nargs: 1 },

        // Regex (returns error if ONIGURUMA not available)
        Cfunction { fptr: None, name: Some("_match_impl"), nargs: 4 },

        // Module functions
        Cfunction { fptr: None, name: Some("modulemeta"), nargs: 1 },
        Cfunction { fptr: None, name: Some("get_search_list"), nargs: 1 },
        Cfunction { fptr: None, name: Some("get_prog_origin"), nargs: 1 },
        Cfunction { fptr: None, name: Some("get_jq_origin"), nargs: 1 },

        // Binary operators (internal)
        Cfunction { fptr: None, name: Some("_negate"), nargs: 1 },
        Cfunction { fptr: None, name: Some("_plus"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_minus"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_multiply"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_divide"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_mod"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_equal"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_notequal"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_less"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_greater"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_lesseq"), nargs: 3 },
        Cfunction { fptr: None, name: Some("_greatereq"), nargs: 3 },
    ];
